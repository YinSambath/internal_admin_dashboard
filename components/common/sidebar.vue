    ...
    <aside class="app-sidebar sticky" :class="{'sticky-pin' : menuOverflowed}" id="sidebar">
        ...
        <div class="main-sidebar-header">
            <NuxtLink  to='/' class="header-logo">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR8zx-z0DHUfBtMgkRyPEM6NTPJmOS4OJCklg&s" alt="logo" class="desktop-logo">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR8zx-z0DHUfBtMgkRyPEM6NTPJmOS4OJCklg&s" alt="logo" class="toggle-logo">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR8zx-z0DHUfBtMgkRyPEM6NTPJmOS4OJCklg&s" alt="logo" class="desktop-dark">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR8zx-z0DHUfBtMgkRyPEM6NTPJmOS4OJCklg&s" alt="logo" class="toggle-dark">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR8zx-z0DHUfBtMgkRyPEM6NTPJmOS4OJCklg&s" alt="logo" class="desktop-white">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR8zx-z0DHUfBtMgkRyPEM6NTPJmOS4OJCklg&s" alt="logo" class="toggle-white">
            </NuxtLink>
        </div>
