    ...
    <header class="app-header">
        ...
        <div class="main-header-container container-fluid">
            ...
            <div class="header-content-right">
                ...
                <!-- Start::Notification::header-element -->
                        ...
                        <a href="javascript:void(0);" class="header-link dropdown-toggle" id="mainHeaderProfile"  v-bind="props">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-sm-block d-none">
                                    <p class="fw-semibold mb-0 lh-1">Name</p>
                                    <span class="op-7 fw-normal d-block fs-11">Position</span>
                                </div>
                            </div>
                        </a>
                    </template>
                    <!-- End::header-link|dropdown-toggle -->
                    <v-list class="main-header-dropdown pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end"
                        aria-labelledby="mainHeaderProfile">
                        <v-list-item>
                            <NuxtLink to="/pages/profile" class="dropdown-item d-flex"><i
                                    class="ti ti-user-circle fs-18 me-2 op-7"></i>Profile</NuxtLink>
                        </v-list-item>
                        <v-list-item>
                            <NuxtLink to="/pages/email/mail-app" class="dropdown-item d-flex"><i
                                    class="ti ti-inbox fs-18 me-2 op-7"></i>Inbox <span
                                    class="badge bg-success-transparent ms-auto">25</span></NuxtLink>
                        </v-list-item>
                        <v-list-item>
                            <NuxtLink to="/pages/to-do-list" class="dropdown-item d-flex border-block-end"><i
                                    class="ti ti-clipboard-check fs-18 me-2 op-7"></i>Task Manager</NuxtLink>
                        </v-list-item>
                        <v-list-item>
                            <NuxtLink to="/pages/email/mail-settings" class="dropdown-item d-flex"><i
                                    class="ti ti-adjustments-horizontal fs-18 me-2 op-7"></i>Settings</NuxtLink>
                        </v-list-item>
                        <v-list-item><a class="dropdown-item d-flex border-block-end" href="javascript:void(0);"><i
                                    class="ti ti-wallet fs-18 me-2 op-7"></i>Bal: $7,12,950</a></v-list-item>
                        <v-list-item>
                            <NuxtLink to="/pages/chat" class="dropdown-item d-flex"><i class="ti ti-headset fs-18 me-2 op-7"></i>Support
                            </NuxtLink>
                        </v-list-item>
                        <v-list-item>
                            <NuxtLink @click="logout" class="dropdown-item d-flex" :to="localePath('/me-portal')"><i
                                    class="ti ti-logout fs-18 me-2 op-7"></i>Log Out</NuxtLink>
                        </v-list-item>
                    </v-list>
                </v-menu>
                <!-- End::header-element -->

                <!-- Start::Locale::header-element -->
                <div class="header-element country-selector" v-for="locale in availableLocales" :key="locale.code">
                    <!-- Start::header-link|dropdown-toggle -->
                    <a href="javascript:void(0);" class="header-link dropdown-toggle" data-bs-auto-close="outside" data-bs-toggle="dropdown">
                        <!-- {{flagImage}} -->
                        <img :src="`${flagImage.image}`" alt="img" class="rounded-circle header-link-icon">
                    </a>
                    <!-- End::header-link|dropdown-toggle -->
                    <ul class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
                        <li>
                            <button class="dropdown-item d-flex align-items-center" @click="changeLanguage(locale.code)">{{locale.name}}
                                <!-- <NuxtLink v-for="locale in availableLocales" :key="locale.code" :to="switchLocalePath(locale.code)"></NuxtLink> -->
                            </button>
                        </li>
                    </ul>
                </div>
...
export default {
    setup() {
        ...
        const flagImage = locales.value.filter((item) => item.code === locale.value)[0];
