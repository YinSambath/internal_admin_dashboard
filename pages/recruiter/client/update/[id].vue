<script lang="ts">
    ...
    export default defineComponent({
        ...
        data() {
            return {
                dataToPass: {
                    current: this.$t('update_kpi'),
                    list: [this.$t('dashboard'), this.$t('indicator_kpi'), this.$t('update_kpi')],
                },
                steps: [
                    { title: 'KPI-Form' },
                ...
                parents: kpiData.logical_frameworks.map(item => ({ id: item.id, label: item.nameKh, value: item.id })),
                body: {
                    id: 0,
                    code: 'ACT00',
                    frameworkId: '',
        ...
        mounted() {
            const kpiId = this.route.params.id;
            ...
            if (kpi) {
                this.body = {
                    ...
                    logicalFrameworkId: kpi.logicalFrameworkId,
                    nameKh: kpi.nameKh,
                    nameEn: kpi.nameEn,
                    weight: kpi.weight,
                    frequencyId: kpi.frequencyId,
                    resourceId: kpi.resourceId,
                    typeId: kpi.typeId,
                    ministryLeadId: kpi.ministryLeadId,
                    ministry: kpi.ministry,
                    practiceYearID: kpi.practiceYearID,
                    groupId: kpi.groupId,
                    parentId: kpi.parentId,
                    calculationMethod: kpi.calculationMethod,
                    dependance: kpi.dependance,
                    numberVariable: kpi.numberVariable,
                    formular: kpi.formular,
                    status: kpi.status, 
        ...
        methods: {
            handleFrameworkChange(value: number) {
                console.log(value)
            },
            ...
            handleNextAction() {
                ...
                if (this.body.calculationMethod) { // check if calculation is checked?
                    ...
                    if (validateMsg === 'ok' ) { // check validation for main form 
                        this.testStore.updateKpi(this.body.id, this.body)
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-3">
                                        <div class="frame-work-input">
                                            <SelectDropdown
                                                :required="true"
                                                :labelField="t('title_name.ministry_line_title')"
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-3">
                                        <div class="frame-work-input">
                                            <SelectDropdown
                                                :required="true"
                                                :labelField="t('title_name.group')"
                                                v-model="body.groupId" 
                                                :items="groups" 
                                                :placeholder="t('placeholder.select_placeholder')" 
                                            />
                                            <div class="error-validation" v-if="errors.groupId">{{ errors.groupId }}</div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-6 col-lg-3">
                                        <div class="frame-work-input">
                                            <el-checkbox v-model="body.dependance">
                                                <label class="label-input-form">{{ t('title_name.dependance_title') }}</label>
                                            </el-checkbox>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-6 col-lg-3">
                                        <div class="frame-work-input">
                                            <el-checkbox v-model="body.calculationMethod">
                                                <label class="label-input-form">{{ t('title_name.calculation_method_title') }}</label>
                                            </el-checkbox>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-6 col-lg-6">
                                        <div class="frame-work-input">
                                            ...
                                            />
                                            <div class="error-validation" v-if="errors.parentId">{{ errors.ministryLeadId }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
